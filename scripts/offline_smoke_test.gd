...
func run() -> void:
	...
	check(count_nodes_with_name_prefix(scene, "RuleSection3DDepthEdge_") == 4 and count_nodes_with_name_prefix(scene, "RuleSection3DTopRim_") == 4 and count_nodes_with_name_prefix(scene, "RuleSection3DExamplePlinth_") == 4, "rule sections render complete physical card and example-plinth layers")
	...
	check(scene.find_child("RulesScrollTexture", true, false) != null and scene.find_child("RulesPatternQuadsTexture", true, false) == null, "rules screen keeps reusable scroll texture and replaces generated pattern strip with native tile examples")
	for group_id in ["sequence", "triplet", "quad", "pair"]:
		check(scene.find_child("RulePatternExampleGroup_%s" % group_id, true, false) != null and scene.find_child("RulePatternExampleTile_%s_0" % group_id, true, false) != null, "rules pattern section renders native %s tile example" % group_id)
	...
	check(scene.find_child("RulesContentScroll", true, false) != null and scene.find_child("RulesContentScrollGutter", true, false) != null and scene.find_child("RulesContentScrollThumb", true, false) != null, "rules screen renders a dedicated scrollable reading viewport with custom dark gutter")
	check(scene.find_child("RulesReadingProgressArt", true, false) != null and scene.find_child("RulesReadingProgressFill", true, false) != null and scene.find_child("RulesReadingProgressRail", true, false) == null and scene.find_child("RulesReadingProgressSource", true, false) == null and scene.find_child("RulesReadingProgressGate", true, false) == null, "rules screen renders reading progress with dynamic fill over GPT plate without code-drawn rail/source/gate")
	check((scene.optional_gpt_illustration_texture("rules_reading_progress_panel") == null) or (scene.find_child("RulesReadingProgressPanelPlate", true, false) != null), "rules reading progress uses optional GPT panel plate")
	check(count_nodes_with_name_prefix(scene, "RulesReadingProgressNode_") == 0 and count_nodes_with_name_prefix(scene, "RulesReadingProgressDrop_") == 0 and count_nodes_with_name_prefix(scene, "RulesReadingProgressTick_") == 0, "rules reading progress drops code-drawn nodes drops and rhythm ticks in favor of GPT plate")
	check(scene.find_child("RulesCompletionConvergenceArt", true, false) != null and scene.find_child("RulesCompletionSource", true, false) != null and scene.find_child("RulesCompletionRoute", true, false) != null and scene.find_child("RulesCompletionFill", true, false) != null and scene.find_child("RulesCompletionGate", true, false) != null, "rules screen renders completion convergence route")
	check(scene.find_child("RulesCompletionSeal", true, false) != null and scene.find_child("RulesCompletionGlyph", true, false) != null and scene.find_child("RulesCompletionPracticeRoute", true, false) != null and scene.find_child("RulesCompletionPracticeFill", true, false) != null and scene.find_child("RulesCompletionPracticeGate", true, false) != null, "rules completion convergence renders seal and practice route")
	check(count_nodes_with_name_prefix(scene, "RulesCompletionNode_") == 4 and count_nodes_with_name_prefix(scene, "RulesCompletionTick_") == 3, "rules completion convergence renders section nodes and rhythm ticks")
	check(scene.find_child("RulesSectionSummaryBusArt", true, false) != null and scene.find_child("RulesSectionSummarySpine", true, false) != null and scene.find_child("RulesSectionSummarySpineFill", true, false) != null and scene.find_child("RulesSectionSummarySource", true, false) != null, "rules sections render summary bus spine and source")
	check(count_nodes_with_name_prefix(scene, "RulesSectionSummaryBranch_") == 4 and count_nodes_with_name_prefix(scene, "RulesSectionSummaryBranchFill_") == 4 and count_nodes_with_name_prefix(scene, "RulesSectionSummaryNode_") == 4, "rules summary bus renders four section branches and nodes")
	check(scene.find_child("RulesSectionSummaryArchiveGate", true, false) != null and scene.find_child("RulesSectionSummaryArchiveGlyph", true, false) != null and scene.find_child("RulesSectionSummaryPracticeRoute", true, false) != null and scene.find_child("RulesSectionSummaryPracticeFill", true, false) != null and scene.find_child("RulesSectionSummaryPracticeGate", true, false) != null, "rules summary bus renders archive gate and practice route")
	check(count_nodes_with_name_prefix(scene, "RulesSectionSummaryTick_") == 4 and count_nodes_with_name_prefix(scene, "RulesSectionSummaryArchivePip_") == 2, "rules summary bus renders rhythm ticks and archive pips")
	...
	check(count_named_nodes(scene, "RuleSectionMarker") == 4, "rules screen renders section markers without code-drawn lead glow")
	...
	check(count_nodes_with_name_prefix(scene, "RuleSectionExampleArt_") == 4 and count_nodes_with_name_prefix(scene, "RuleGoalGroup_") == 5 and count_nodes_with_name_prefix(scene, "RuleGoalGroupLink_") == 4, "rules sections render concrete example art goal groups and links")
	...
	check(count_nodes_with_name_prefix(scene, "RuleSectionExampleTile_1_") == 3 and scene.find_child("RulePairExampleBack", true, false) != null and count_nodes_with_name_prefix(scene, "RuleSectionExamplePairTile_") == 2, "rules tile section renders sequence and pair tile examples")
	check(scene.find_child("RuleSpecialExampleRail", true, false) != null and count_nodes_with_name_prefix(scene, "RuleSevenPairsNode_") == 7 and scene.find_child("RuleOrphanBadge", true, false) != null, "rules special hand section renders rail seven-pairs and orphan examples")
	...
	check(scene.find_child("RuleActionPriorityRoute", true, false) != null and scene.find_child("RuleActionPriorityFill", true, false) != null and scene.find_child("RuleActionPrioritySource", true, false) != null and scene.find_child("RuleActionWinGate", true, false) != null, "rules action section renders priority-to-win route")
	check(count_nodes_with_name_prefix(scene, "RuleActionPriorityTick_") == 3, "rules action priority route renders rhythm ticks")
