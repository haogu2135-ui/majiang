...
| 策略质量 | 规划奖励不重复、候选各自评估路线、末盘吃碰/杠牌纪律和安全替代判定稳定 | R63、R67、R87、R88、R90 | 无 |
| 账本与稳定性 | 牌墙、手牌、河牌、副露、花牌合计保持 144 张；四座总分守恒；新场景模拟能终局 | R66、R74、R82 | 无 |
| 难度与强度 | easy/normal/hard 均可终局；hard 在配对牌墙和固定玩家探针下通过危险率、可避免压力与放铳门槛 | R68、R82、R89、R90 | `build/qa/ai_play_commercial_evidence/STRENGTH_PACK_LATEST.md` |
